        ...
        for role, person_id in instances(obligation, graph):
            ...
            findings.append(
                store.finding(
                    ...
                    obligation_id=obligation.obligation_id,
                    qualification_interne=obligation.qualification_interne_fr,
                    gravite_interne=obligation.gravite_interne,
                    penal_refs=[a.chunk_id for a in obligation.penal_anchors],
                    evidence_pointers={
                        "fact_ids": list(ev.matched_fact_ids),
                        "candidate_fact_ids": list(ev.candidate_fact_ids),
                        "trigger_fact_id": ev.trigger_fact_id,
                        "scope_doc_ids": list(ev.scope_doc_ids),
